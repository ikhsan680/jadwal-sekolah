...
<body class="min-h-screen flex flex-col relative">
  ...
  <!-- Masukan Kode + Toggle Mata -->
  <div>
    <label for="codeInput" class="block text-sm font-medium text-gray-700 mb-1">Kode Guru</label>
    <div class="relative">
      <input type="password" id="codeInput" name="kode" placeholder="Masukan Kode Guru" required
        class="w-full text-base border border-indigo-300 rounded-lg px-4 py-3 
               focus:outline-none focus:ring-2 focus:ring-indigo-500 
